    ...
    <SafeAreaProvider>
      <SafeAreaView>
        <View style={styles.inputContainer}>
          <Icon name="accessibility" size={24} color="lightblue" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="clear" size={24} color="purple" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="school" size={24} color="green" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="note" size={24} color="orange" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="email" size={24} color="red" style={styles.icon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputContainer}>
          <Icon name="info" size={24} color="brown" style={styles.icon} />
          <TextInput
            editable
            multiline
            numberOfLines={4}
